const CLASS_STYLES: Record<string, string> = {
  ...
  Challenger:  'bg-sky-500/20 text-sky-300 border border-sky-500/30',
  Established: 'bg-violet-500/20 text-violet-300 border border-violet-500/30',
  Influencer:  'bg-amber-500/20 text-amber-300 border border-amber-500/30',
  Star:        'bg-rose-500/20 text-rose-300 border border-rose-500/30',
};
